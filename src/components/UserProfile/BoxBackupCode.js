  ...
  return (
    <div>
      <div className={styles.ox_box_wrapper_backupcode}>
        ...
        <p className="ox_mb_8">
          Backup codes are now enabled. You can use one of these to sign in to your account, if you
          lose access to your authentication device. Each code can only be used once.
        </p>
        ...
        <div className={styles.ox_box_auth_code}>
          {backupCodes.map((i) => {
            return <div className={styles.ox_box_backupcode_item}>{i}</div>
          })}
        </div>
        <div className={styles.ox_box_action_code}>
          ...
          <Button style={{ width: 150 }}>
            <span className="ox_text_primary_700" onClick={copyText}>
              {icCopy}
            </span>
          </Button>
        </div>
